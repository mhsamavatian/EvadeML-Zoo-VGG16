...
from models.keras_models import keras_vgg16_imagenet_model
...
class ImageNetDataset:
    ...
    def get_test_dataset(self, img_size=224, num_images=100):
        ...
        X /= 255
        return X, Y
    def set_size(self,img_size=224):
        self.image_size = img_size
    ...
    def load_model_by_name(self, model_name, logits=False, input_range_type=1, input_tensor=None, pre_filter=lambda x:x):
        ...
        if model_name == 'resnet50':
            ...
            model = keras_vgg16_imagenet_model(logits=logits, input_range_type=input_range_type)
        else:
